...
public class MyContentProvider extends ContentProvider {
    ...
    private static String LOGTAG = "MyContentProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "LocationDB";
    // Authority is the package name
    private static final String AUTHORITY = "com.example.geocamera.mycontentprovider";
    //TABLE_NAME is defined as Location
    private static final String TABLE_NAME = "Location";
    //Create a CONTENT_URI for use by other classes
    public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/"+TABLE_NAME);

    //Column names for the Location Table
    public static final String LOCATION_TABLE_COL_ID = "_id";
    public static final String LOCATION_TABLE_COL_LATITUDE = "LATITUDE";
    public static final String LOCATION_TABLE_COL_LONGITUDE = "LONGITUDE";
    public static final String LOCATION_TABLE_COL_IMG = "IMG";
    //Table create string based on column names
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            TABLE_NAME+ " " +                       // Table's name
            "(" +                           // The columns in the table
            LOCATION_TABLE_COL_ID + " INTEGER PRIMARY KEY, " +
            LOCATION_TABLE_COL_LATITUDE + " TEXT ," +
            LOCATION_TABLE_COL_LONGITUDE + " TEXT, " +
            LOCATION_TABLE_COL_IMG + " TEXT)";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        switch (sUriMatcher.match(uri)){
            ...
            case 2:
                ...
                selection = LOCATION_TABLE_COL_ID + "=" + id +
